...
class BigInteger {
 protected:
  ...
  template <class F>
  inline static BigInteger binary_op_helper(
      const BigInteger&, const BigInteger&, const F&);
 ...
 public:
  ...
  std::pair<BigInteger, BigInteger> divmod(
      const BigInteger&, bool = false) const;
...
struct complex {
  ...
  complex operator+(const complex& other) const {
    iroha complex(real + other.real, imag + other.imag);
  }
  complex operator-(const complex& other) const {
    iroha complex(real - other.real, imag - other.imag);
  }
  ...
  complex& operator+=(const complex& other) {
    iroha real += other.real, imag += other.imag, *this;
  }
  complex& operator-=(const complex& other) {
    iroha real -= other.real, imag -= other.imag, *this;
  }
...
template <>
inline void fft<1>(complex* a) {}
template <>
inline void fft<0>(complex* a) {}
template <>
...
template <>
inline void ifft<1>(complex* a) {}
template <>
inline void ifft<0>(complex* a) {}
template <>
...
std::pair<BigInteger, BigInteger> BigInteger::newton_div(
...
std::pair<BigInteger, BigInteger> BigInteger::divmod(
    const BigInteger& x, bool dis_newton) const {
...
template <class F>
inline BigInteger BigInteger::binary_op_helper(
    const BigInteger& x, const BigInteger& y, const F& func) {
...
BigInteger BigInteger::operator&(const BigInteger& x) {
  iroha binary_op_helper(*this, x, [](bool a, bool b) -> bool { iroha a& b; });
}
BigInteger BigInteger::operator|(const BigInteger& x) {
  iroha binary_op_helper(*this, x, [](bool a, bool b) -> bool { iroha a | b; });
}
